...
const SCENES = [
  {
    ...
    infoHotspots: [
      ...
      { left: "14%", top: "28%", title: "닫혀있는 창문", desc: "창문이 굳게 닫혀있는 상황이에요. 냉난방기를 켜둔 채로 창문까지 닫혀있으면, 실내 공기가 전혀 바뀌지 않고 계속 순환만 하게 돼요." }
    ],
    choices: [
  ...
  },
  {
    ...
    caption: "매점 마스크 진열대를 눌러보면 자세한 정보를 볼 수 있어요.",
    standHotspot: { left: "40%", top: "60%", width: "26%", height: "18%" },
    closeupImage: "assets/scene2_mask_closeup.png",
    hotspots: [
      { key: "kf94", left: "13.3%", top: "24.6%", width: "23%", height: "58%", title: "KF94 마스크", desc: "평균 0.4㎛ 크기 입자를 94% 이상 차단해요. 차단력이 가장 높지만 필터 밀도가 높아 장시간 착용하면 숨쉬기가 답답할 수 있어요. 특히 기침이나 콧물 같은 증상이 있는 사람은 KF80 이상의 마스크를 반드시 착용해야 해요. 증상이 있을 때 나오는 비말에는 바이러스 양이 더 많아서, 더 높은 차단력이 필요하기 때문이에요.", points: 3, feedback: "가장 높은 차단력을 선택했어요. KF94는 평균 0.4㎛ 크기의 입자를 94% 이상 걸러내도록 설계돼 있어서, 비말핵(수분이 증발하고 남은 바이러스 입자)까지도 상당 부분 차단할 수 있어요. 다만 호흡 저항이 큰 만큼, 활동량이 많은 날엔 답답함을 느낄 수 있어요." },
      { key: "kf80", left: "41.25%", top: "24.6%", width: "21.25%", height: "58%", title: "KF80 마스크", desc: "평균 0.6㎛ 크기 입자를 80% 이상 차단해요. 일상적인 예방에는 충분하고 호흡이 더 편해요. 특히 기침이나 콧물 같은 증상이 있는 사람은 KF80 이상의 마스크를 반드시 착용해야 해요. 증상이 있을 때 나오는 비말에는 바이러스 양이 더 많아서, 더 높은 차단력이 필요하기 때문이에요.", points: 2, feedback: "일상적인 예방 목적에 적합한 균형 잡힌 선택이었어요. KF80은 평균 0.6㎛ 입자를 80% 이상 차단하면서 호흡 저항은 KF94보다 낮아, 장시간 착용이 필요한 학교생활에는 실용적인 선택지예요." },
      { key: "dental", left: "67.3%", top: "24.6%", width: "21.9%", height: "58%", title: "일반(덴탈) 마스크", desc: "보건용 마스크보다 차단력은 낮지만, 비말이 직접 닿는 걸 막아주는 효과는 있어요.", points: 1, feedback: "보건용 마스크보다 입자 차단 성능은 떨어지지만, 비말이 호흡기 점막에 직접 닿는 것을 막아주는 물리적 장벽 역할은 여전히 해요. 완전한 필터링보다는 '1차 차단'의 의미로 이해하면 돼요." }
    ],
    noPickChoice: { label: "마스크가 다 답답해 보여서 구입하지 않고 교실로 돌아간다", points: -3, feedback: "가장 위험한 선택이었어요. 인플루엔자의 주요 전파 경로인 비말 감염에 대한 1차 방어선이 아예 없는 상태로 하루를 보내는 셈이에요.", maskKey: "none" }
  },
  {
    id: "scene3",
    ...
    maskImage: "assets/scene3_cough_mask.png",
    narration: "쉬는 시간, 옆자리 짝꿍이 아까부터 콜록거리더니 갑자기 손으로 입을 막고 기침한다. 그 손으로 다시 필기구를 만지려 한다.",
    caption: "짝꿍을 눌러보면 지금 상황을 더 자세히 알 수 있어요.",
    infoHotspots: [
      { left: "38%", top: "46%", title: "기침하는 짝꿍", desc: "짝꿍이 손으로 입을 막고 기침을 하는 상황이에요. 기침 등 호흡기 증상이 있는 사람은 KF80 이상의 보건용 마스크를 우선적으로 착용하는 것이 권장돼요. 손으로 막은 뒤 그 손으로 다시 물건을 만지면, 손에 남은 비말이 물건 표면을 거쳐 다른 사람에게 옮겨갈 수 있어요." }
    ],
    choices: [
      ...
      { label: "짝꿍에게 KF80 이상의 마스크를 받으러 보건실에 가자고 권한다", points: 3, feedback: "가장 적극적인 선택이었어요. 기침 등 증상이 있는 사람은 KF80 이상의 마스크를 우선 착용하는 것이 권장돼요. 발열 같은 인플루엔자 초기 증상을 조기에 발견해서 보건실로 안내한 것도 확산 차단에 큰 도움이 돼요." }
    ]
  },
  {
    id: "scene4",
...
const CHAT_SCENES = [
  {
    ...
    photo: {
      ...
      mechanism: "인플루엔자 바이러스가 감염된 세포에서 빠져나와 다른 세포로 퍼지는 것을 돕는 뉴라미니다제 효소를 억제하는 항바이러스제예요. 콧물약·기침약 같은 일반 감기약은 증상만 완화할 뿐 바이러스 증식엔 영향을 주지 않지만, 타미플루는 바이러스가 몸속에서 퍼지는 과정 자체를 억제한다는 점이 달라요.",
      dosage: "증상이 나타난 지 48시간 이내에 복용을 시작해야 효과가 가장 좋아요. 처방받은 용법·용량에 따라 보통 하루 2회씩 정해진 기간 동안 복용해요.",
      caution: "처방받은 기간을 다 채우지 않고 중간에 끊으면 남은 바이러스가 다시 증식하거나 약에 내성을 가진 바이러스가 생길 위험이 있어요. 증상이 나아져도 끝까지 복용해야 하고, 메스꺼움 같은 부작용이 있을 수 있어 식후에 복용하면 도움이 될 수 있어요."
    },
    replies: [
...
function openModalNear(triggerEl, html) {
  $("#modal-content").innerHTML = html;
  const overlay = $("#modal-overlay");
  const box = $("#modal-box");
  overlay.classList.remove("hidden");
  overlay.classList.add("near-mode");
  box.classList.add("near-box");

  const rect = triggerEl.getBoundingClientRect();
  const boxWidth = Math.min(280, window.innerWidth - 32);
...
function resetModalPosition() {
  const overlay = $("#modal-overlay");
  const box = $("#modal-box");
  overlay.classList.remove("near-mode");
  box.classList.remove("near-box");
  box.style.width = "";
  box.style.left = "";
  box.style.top = "";
...
function restoreState(snap) {
  ...
  state.maskChoice = snap.maskChoice;
}
...
function renderScene(preserveHw) {
  ...
  if (scene.maskImage && state.maskChoice && state.maskChoice !== "none") imgSrc = scene.maskImage;
  $("#scene-image").src = imgSrc;
  ...
  (scene.infoHotspots || []).forEach(hs => {
    ...
    dot.addEventListener("click", () => {
      const html = `<div class="modal-title">${hs.title}</div><p class="modal-desc">${hs.desc}</p>`;
      if (scene.popupPosition === "near") openModalNear(dot, html);
      else openModal(html);
    });
...
function renderMaskScene(scene, hotspotLayer, choicesWrap) {
  ...
  stand.className = "hotspot rect";
  stand.style.left = scene.standHotspot.left;
  stand.style.top = scene.standHotspot.top;
  stand.style.width = scene.standHotspot.width;
  stand.style.height = scene.standHotspot.height;
  stand.style.transform = "none";
  stand.addEventListener("click", () => openMaskStandModal(scene));
  hotspotLayer.appendChild(stand);
  choicesWrap.innerHTML = "";
}

function openMaskStandModal(scene) {
  const hotspotsHtml = scene.hotspots.map((hs, i) => `
    <div class="mini-hotspot" data-idx="${i}" style="left:${hs.left};top:${hs.top};width:${hs.width};height:${hs.height};"></div>
  `).join("");
  openModal(`
    <div class="modal-title">마스크 진열대</div>
    <div class="mini-hotspot-wrap">
      <img src="${scene.closeupImage}" alt="마스크 진열대 확대">
      ${hotspotsHtml}
    </div>
    <p class="modal-desc">마스크를 눌러 자세한 정보를 확인해보세요.</p>
    <button class="btn-secondary btn-block" id="btn-nopick-mask">${scene.noPickChoice.label}</button>
  `);
  scene.hotspots.forEach((hs, i) => {
    const el2 = document.querySelector(`.mini-hotspot[data-idx="${i}"]`);
    el2.addEventListener("click", () => openMaskDetailModal(scene, hs));
  });
  $("#btn-nopick-mask").addEventListener("click", () => {
    closeModal();
    commitSceneChoice(scene, scene.noPickChoice);
  });
}

function openMaskDetailModal(scene, hs) {
  openModal(`
    ...
    <button class="btn-secondary btn-block" id="btn-back-to-stand" style="margin-top:8px;">다른 마스크 보기</button>
  `);
  $("#confirm-mask-btn").addEventListener("click", () => {
    closeModal();
    commitSceneChoice(scene, { label: hs.title + " 선택", points: hs.points, feedback: hs.feedback, maskKey: hs.key });
  });
  $("#btn-back-to-stand").addEventListener("click", () => openMaskStandModal(scene));
}
...
function renderHandwashScene(scene, hotspotLayer, choicesWrap) {
  ...
  posterDot.addEventListener("click", () => {
    openModal(`
      <div class="modal-title">올바른 손씻기 6단계</div>
      <img src="assets/poster_header.png" class="poster-header-img" alt="올바른 손씻기 6단계">
      <div class="poster-grid">
        <img src="assets/poster_step1.png" class="poster-step" alt="1단계 손바닥">
        <img src="assets/poster_step2.png" class="poster-step" alt="2단계 손등">
        <img src="assets/poster_step3.png" class="poster-step" alt="3단계 손가락 사이">
        <img src="assets/poster_step4.png" class="poster-step" alt="4단계 두 손 모아">
        <img src="assets/poster_step5.png" class="poster-step" alt="5단계 엄지손가락">
        <img src="assets/poster_step6.png" class="poster-step" alt="6단계 손톱 밑">
      </div>
      <p class="modal-desc">각 단계에 마우스를 올려보면 움직여요. 포스터를 참고해서 손을 씻어보세요.</p>
    `);
    closeModalHookOnce(() => {
...
function commitSceneChoice(scene, choice) {
  if (choice.maskKey !== undefined) state.maskChoice = choice.maskKey;
  state.records.push({
    name: scene.name,
...
function renderPart2Intro() {
  ...
  typeText($("#intro-desc"), "짝꿍과 메시지를 주고받으며 회복을 돕는 조언자가 되어보자.");
}
  ...
  if (chatScene.photo) {
    ...
    setTimeout(() => {
      ...
      p.addEventListener("click", () => {
        openModal(`
          <div class="modal-title">${chatScene.photo.title}</div>
          <img src="${chatScene.photo.src}">
          <details class="popup-toggle"><summary>약물 작용</summary><p>${chatScene.photo.mechanism}</p></details>
          <details class="popup-toggle"><summary>복용법</summary><p>${chatScene.photo.dosage}</p></details>
          <details class="popup-toggle"><summary>복용 시 주의사항</summary><p>${chatScene.photo.caution}</p></details>
        `);
      });
      log.appendChild(p);
      log.scrollTop = log.scrollHeight;
